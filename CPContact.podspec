...
Pod::Spec.new do |s|
  s.name             = 'CPContact'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CPContact.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/CPContact'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xiaochengfei' => 'xiaochengfei@didichuxing.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/CPContact.git', :tag => s.version.to_s }
